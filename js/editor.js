    ...
    <div class="field-config">
      ...
      <div class="field-config-item field-formula-container" style="display: ${
        ...
        <div class="formula-hint">
          ...
          {id_поля,map,'выражение'} - применить выражение к каждой строке<br>
          Сумма: {sum,fieldA,fieldB,...} — суммирует все числа, найденные в значениях указанных полей или поля (например если указать несколько чисел в одной строке - они суммируются)
        </div>
      </div>
